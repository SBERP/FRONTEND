...
modules: [{
    name: 'toaster',
    files: ['app/vendor/angularjs-toaster/toaster.js',
    'app/vendor/angularjs-toaster/toaster.css'
]
},
{
    name: 'ui.knob',
    files: ['app/vendor/angular-knob/src/angular-knob.js',
...
{
    name: 'angular-chosen',
    files: ['app/vendor/chosen_v1.2.0/chosen.jquery.min.js',
...
{
    name: 'ui.calendar',
    files: ['app/vendor/fullcalendar/dist/fullcalendar.min.js',
...
{
    name: 'uiCropper',
    files: ['app/js/customeCSS/ui-cropper.css',
    'app/js/customeJS/ui-cropper.js'
]
},
{
    name: 'treeGrid',
    files: ['app/vendor/tree-grid/treeGrid.css',
    'app/vendor/tree-grid/tree-grid-directive.js'
]
},
{
    name: 'pusher-angular',
    files: ['https://js.pusher.com/4.1/pusher.min.js',
...
{ name: 'debitNote', files: ['app/js/controllers/Accounting/DebitNotes/DebitNoteCtrl.js'] },
{
    name: 'treeControl',
    files: [
        'app/js/customeJS/tree-control/angular-tree-control.js',
        'app/js/customeJS/tree-control/context-menu.js',
        'app/js/customeCSS/tree-control.css'
    ]
},
{
    name: 'dragNdrop',
    files: [
        'app/js/customeJS/drag-n-drop.js',
    ]
},
{
    name: 'angular-ui-sortable',
    files: [
        'app/js/customeJS/angular-ui-sortable.js',
    ]
},
{
    name: 'datatable',
    files: [
        ...
        '//cdnjs.cloudflare.com/ajax/libs/angular-data-table/0.6.0/dataTable.min.css',
        '//cdn.datatables.net/buttons/1.2.2/css/buttons.dataTables.min.css',
        '//cdn.datatables.net/1.10.19/js/jquery.dataTables.min.js',
        '//cdn.datatables.net/buttons/1.2.2/js/dataTables.buttons.min.js',
        '//cdnjs.cloudflare.com/ajax/libs/angular-datatables/0.6.2/angular-datatables.min.js',
        '//cdnjs.cloudflare.com/ajax/libs/angular-datatables/0.6.2/plugins/buttons/angular-datatables.buttons.min.js',
        '//cdnjs.cloudflare.com/ajax/libs/angular-datatables/0.6.2/plugins/colreorder/angular-datatables.colreorder.min.js',
        '//cdn.datatables.net/buttons/1.2.2/js/buttons.colVis.min.js',
...
.constant('apiPath', {
    ...
    'getBulkCategory': 'product-categories/bulk',
    'getAllGroup': 'product-groups',
    'getBulkGroup': 'product-groups/bulk',
    ...
    'getLedgerByCompanyGroup': 'accounting/ledgers/company/ledgerGrp/',
    ...
    'getGstReturn3b': 'accounting/taxation/gst-r3b/company/',
...
.constant('hostUrl', {
    ...
    'enterpriceArihant': 'http://api.arihantdeals.com/',
    'salesArihant': 'http://saleapi.arihantdeals.com/',
    'swaminarayan': 'http://api.swaminarayancycles.com/',
    'swaminarayanNew': 'http://swaminarayanapi.siliconbraintechnosoft.com/',
...
.constant('hostFrontUrl', {
    ...
    'enterpriceArihant': 'http://enterprise.arihantdeals.com/',
    'salesArihant': 'http://sales.arihantdeals.com/',
    'swaminarayan': 'http://erp.swaminarayancycles.com/',
    'swaminarayanNew': 'http://swaminarayanerp.siliconbraintechnosoft.com/',
...
.constant('googleSiteKey', {
    ...
    'enterpriceArihant': '6LdoIWcUAAAAAEeQ7nRQURyoGe0GkQg7U4w0EDHD',
    'salesArihant': '6Le8IWcUAAAAAPnCzcSjn0wwp-uOoPf-_vsd5tvN',
    'swaminarayan': '6Leb_z8UAAAAADbbEgHvvgi3i5Bilm27tASJCPUd',
    'swaminarayanNew': '6LdhIGcUAAAAAAxXB4LjzDiDtDqL5l-MV9Q0v_jP',
