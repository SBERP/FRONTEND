...
App.controller('AccSalesTaxationController', AccSalesTaxationController);

function AccSalesTaxationController($rootScope,$scope, $filter, ngTableParams,apiCall,apiPath,apiResponse,toaster,getSetFactory,$window) {
  'use strict';
  var vm = this;
	//$scope.brandradio="";
  ...
  var data = [];
	...
	$scope.getProduct = function(id){
		...
		apiCall.getCall(apiPath.getSalesTax+id).then(function(response){
  ...
  /*** Pdf ***/
		...
		$scope.generatePdf = function(operation){
			...
			apiCall.getCallHeader(apiPath.getSalesTax+$scope.stateCheck.companyId,getData).then(function(responseDrop){
...
AccSalesTaxationController.$inject = ["$rootScope","$scope", "$filter", "ngTableParams","apiCall","apiPath","apiResponse","toaster","getSetFactory","$window"];