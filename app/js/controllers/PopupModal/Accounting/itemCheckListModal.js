...
function AccDispatchItemModalController($scope,toaster,$modalInstance,$filter,statusType,billData,productFactory,ngTableParams,$rootScope,apiCall,apiPath,validationMessage,apiResponse){
            ...
            while(dIndex < dLength)
            {
                (function(dIndex2){
                    ...
                    if (dIndex2 == dLength - 1) {
                        ...
                        // console.log('remainingInv.length',remainingInv.length);
    ...
    function postDispatchData(formdata2,callback) {
        ...
        apiCall.postCall(jrnSavePath,formdata2).then(function(response)
        {
            ...
            if(apiResponse.ok == response){
                ...
                toaster.clear();
                console.log('toaster response',response);
    ...
    {
        return `<table cellspacing=0 style="border: 1px solid #535252;border-collapse: collapse;width: `+printTableWidth+`;float: left; margin: 10px;"><tbody>
    ...
    function tableWrapperEnds(companyObject)
    {
        ...
        <td style="font-family:Arial;border-top: 1px solid #535252;text-align:left;font-size:12px;background-color:#ffffff;min-width:50px;vertical-align:top;" colspan="5">
        <strong>Del. By:</strong>
        </td>
        <td style="font-family:Arial;border-top: 1px solid #535252;text-align:right;font-size:15px;background-color:#ffffff;min-width:50px;vertical-align:top;" colspan="5">
    ...
    function clientOrderHeader(billObject)
    {
        ...
        <td style="font-family:Arial;font-size:12px;min-width:50px;border:1px solid #535252;border-bottom:0px;" colspan=8 rowspan=2>
        <strong>&nbsp;&nbsp;M/S. :</strong>
        <strong>`+billObject.client.clientName+`</strong><br>
        <nobr style="font-size:10px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;`+billObject.client.address1+`</nobr>
        </td>
        <td style="font-family:Arial;text-align:left;font-size:10px;min-width:50px;padding-left: 10px;border:1px solid #535252;border-bottom-color: #fff;" colspan=2>
        <strong>Date : </strong>
        <nobr>`+billObject.entryDate+`</nobr>
        </td>
        </tr>
        <tr style="height:17px;">
        <td style="font-family:Arial;text-align:left;font-size:10px;min-width:50px;padding-left: 10px;border-right:1px solid #535252;" colspan=2>
        <strong>Challan #: </strong>
        <nobr>`+billObject.invoiceNumber+`</nobr>
        </td>
        </tr>
        <tr style="height:24px;">
        <td style="font-family:Arial;font-size:12px;min-width:50px;border:1px solid #535252;border-top:0px;" colspan=8 >
        <strong>&nbsp;&nbsp;Phone :</strong>
        <nobr>`+billObject.client.contactNo+`</nobr>
        </td>
        <td style="font-family:Arial;text-align:left;font-size:10px;min-width:50px;padding-left: 10px;border-right:1px solid #535252;" colspan=2>
        <strong>PO #: </strong>
        <nobr>`+billObject.poNumber+`</nobr>
        </td>
        </tr>`;
    }
    function deliveredItemTable(itemArray,callback)
    {
        ...
        returnableStr += `
        <tr style="height:24px;">
        <td style="font-family:Arial;font-size:9px;color:#000;font-weight:bold;border:1px solid #535252;width:50px;text-align:center;">
        <nobr>Sr No</nobr>
        </td>
        <td style="font-family:Arial;font-size:9px;color:#000;font-weight:bold;border:1px solid #535252;min-width:50px" colspan=7>
        <nobr>&nbsp;&nbsp;Name of Particulars</nobr>
        </td>
        <td style="font-family:Arial;text-align:center;font-size:9px;color:#000;font-weight:bold;border:1px solid #535252;width:80px">
        <nobr>Qty</nobr>
        </td>
        <td style="font-family:Arial;text-align:center;font-size:9px;color:#000;font-weight:bold;border:1px solid #535252;width:80px">
        <nobr>Unit</nobr>
        ...
        while(itemIndex < totalItems)
        {
            (function(itIndex){
                ...
                returnableStr += `
                <tr style="height:17px;">
                <td style="font-family:Arial;font-size:9px;border-left:1px solid;border-left-color:#535252;min-width:50px;text-align:center;">
                <nobr>`+(itIndex+1)+`</nobr>
                </td>
                <td style="font-family:Arial;text-align:left;font-size:9px;border-left:1px solid;border-left-color:#535252;min-width:50px" colspan=7>
                <nobr>&nbsp;`+itemText+`</nobr>
                </td>
                <td style="font-family:Arial;text-align:center;font-size:9px;border-left:1px solid;border-right:1px solid;border-left-color:#535252;border-right-color:#535252;min-width:50px">
                ...
                if (itIndex == totalItems-1) {
                    ...
                    <td style="border-left:1px solid #535252;border-right:1px solid #535252;"></td>
                    <td style="border-left:1px solid #535252;border-right:1px solid #535252;" colspan=7></td>
                    <td style="border-left:1px solid #535252;border-right:1px solid #535252;"></td>
                    <td style="border-left:1px solid #535252;border-right:1px solid #535252;"></td>
                    </tr>
                    <tr style="height:17px;">
                    <td style="border:1px solid #535252;"></td>
                    <td style="border:1px solid #535252;" colspan=7></td>
                    <td style="font-family:Arial;font-size:9px;border:1px solid #535252;text-align:center">
